...
namespace FusionMiner.Thrift
{
  ...
  [Serializable]
  #endif
  public partial class MinerStatus : TBase
  {
    ...
    public void Write(TProtocol oprot) {
      TStruct struc = new TStruct("MinerStatus");
      oprot.WriteStructBegin(struc);
      TField field = new TField();
      if (Miner != null && __isset.Miner) {
        field.Name = "Miner";
      ...
      if (CurrentPool != null && __isset.CurrentPool) {
        field.Name = "CurrentPool";
        field.Type = TType.String;
        field.ID = 9;
        oprot.WriteFieldBegin(field);
        oprot.WriteString(CurrentPool);
        oprot.WriteFieldEnd();
      }
    ...
    public override string ToString() {
      StringBuilder __sb = new StringBuilder("MinerStatus(");
      bool __first = true;
      if (Miner != null && __isset.Miner) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
        __sb.Append("Miner: ");
        __sb.Append(Miner== null ? "<null>" : Miner.ToString());
      }
      if (__isset.Utc) {
        if(!__first) { __sb.Append(", "); }
        __first = false;
